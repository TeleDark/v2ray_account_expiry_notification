...
green='\033[0;32m'
plain='\033[0m'
wk_dir=~/v2ray_account_expiry_notification
config_dir=~/v2ray_account_expiry_notification
config_file=config.yaml
git_url="https://github.com/TeleDark/v2ray_account_expiry_notification.git"
...
install_base() {
    case "${release}" in
        centos|fedora)
            ...
            ;;
        *)
            apt-get update && apt-get install -y git wget python3 cron
            ;;
    esac
}
